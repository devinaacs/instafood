  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View
          style={{ backgroundColor: 'blue', height: 220, paddingVertical: 10 }}
        >
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            ...
            >
              <Image
                ...
                source={{
                  uri: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80',
                }}
              />
              <View
                style={{
            ...
            >
              <Image
                ...
                source={{
                  uri: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=780&q=80',
                }}
              />
              <View
                style={{
        ...
        <View
          style={{ backgroundColor: 'white', height: 50, paddingVertical: 10 }}
        >
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
